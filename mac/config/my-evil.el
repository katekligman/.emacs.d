;; This file is largely copied from github.com:nathantypanski/emacs.d
;;
;; my-evil.el
;;
...
;; kate
    ...
    (define-key evil-motion-state-map "zj"           'evil-next-visual-line)
    (define-key evil-motion-state-map "zk"           'evil-previous-visual-line)
